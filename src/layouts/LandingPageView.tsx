...
export default function LandingPageView() {
    const features = [
        { icon: faCopy, title: "Clonar Landing Pages", description: "Clonar qualquer landing page com precisão em segundos." },
        { icon: faCode, title: "Código-Fonte Pronto", description: "Obter o código-fonte completo, pronto para personalização." },
        { icon: faPenToSquare, title: "Personalização Fácil", description: "Personalizar facilmente, sem precisar de conhecimentos avançados em programação." },
        { icon: faChartLine, title: "Aumente Conversões", description: "Aprimorar suas campanhas de marketing e aumentar suas conversões rapidamente." },
        { icon: faMoneyBill, title: "Hospedagem Gratuita", description: "Publique suas páginas clonadas sem custos adicionais, de forma rápida e segura." },
        { icon: faBullseye, title: "Melhores Estratégias", description: "Capture as melhores estratégias e implemente rapidamente." }
    ];

    const steps = [
        { number: "1", title: "Insira a URL da landing page", description: "Insira a URL da landing page que deseja clonar na Copyei." },
                ...
                <div className={style.containerLp}>
                    <div className={style.bannerLp}>
                        <div className={style.contentBanner}>
                            ...
                            <h2>A ferramenta definitiva para capturar, personalizar <br /> e lançar landing pages vencedoras.</h2>
                            <Link href="/login" passHref>
                                <button className={style.buttonLp}>Acessar</button>
                            </Link>
                        </div>
                        <div className={style.imageBanner}>
                            <Image src="/images/imagebanner.png" alt="Copyei" width={300} height={150} className={style.imageBannerLp} />
                        </div>
                    </div>
                </div>
