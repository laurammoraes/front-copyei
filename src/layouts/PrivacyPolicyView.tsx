...
export function PrivacyPolicyView() {
  return (
    <div className={style.containerPageText}>
      <div className={style.formatTxt}>
        <h2>Políticas de privacidade</h2>
        <p>
          A sua privacidade é importante para nós. É política do Copyei respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Copyei e outros sites que possuímos e operamos.
        </p>
        <p>
        ...
        <p>
          Não compartilhamos informações de identificação pessoal de Produtores cadastrados na plataforma, exceto quando exigido por lei, ordem judicial ou a pedido de um Comprador para fins de identificação de quem vendeu-lhe o respectivo infoproduto, ou de pessoa legitimamente interessada.
        </p>
        <p>
        ...
        <h3>Política de Cookies Copyei</h3>
        ...
        <p>
          À medida que vendemos produtos, é importante entendermos as estatísticas sobre quantos visitantes de nosso site realmente compram e, portanto, esse é o tipo de dados que esses cookies rastrearão. Isso nos permite analisar nossos custos de publicidade e produtos para garantir o melhor preço possível.
        </p>
